...
(function () {
    ...
    aa._$62                           = function (aQ, aU) {
        try {
            ...
            if (aN > ay._$T7) {
                aQ._$NP |= aa._$4s;
                var aR = ay._$T7;
                var aI = "_$gi _$C _$li , _$n0 _$_ version _$li ( SDK : " + aR + " < _$f0 : " +
                        aN + " )@_$SS#loadModel()\n";
                throw new J(aI);
            }
            var aL = aS._$nP();
    ...
    aa.prototype.setParamFloat        = function (aH, aJ, aI) {
        ...
        this
            ._$5S
            .setParamFloat(aH, this._$5S.getParamFloat(aH) * (1 - aI) + aJ * aI);
    };
    aa.prototype.addToParamFloat      = function (aH, aJ, aI) {
        ...
        this
            ._$5S
            .setParamFloat(aH, this._$5S.getParamFloat(aH) + aJ * aI);
    };
    aa.prototype.multParamFloat       = function (aH, aJ, aI) {
        ...
        this
            ._$5S
            .setParamFloat(aH, this._$5S.getParamFloat(aH) * (1 + (aJ - 1) * aI));
    };
    ...
    aa.prototype.setPartsOpacity      = function (aI, aH) {
        if (typeof aI != "number") {
            aI = this
                ._$5S
                .getPartsDataIndex(i.getID(aI));
        }
        this
            ._$5S
            .setPartsOpacity(aI, aH);
    };
    aa.prototype.getPartsDataIndex    = function (aH) {
        ...
        return this
            ._$5S
            .getPartsDataIndex(aH);
    };
    aa.prototype.getPartsOpacity      = function (aH) {
        if (typeof aH != "number") {
            aH = this
                ._$5S
                .getPartsDataIndex(i.getID(aH));
        }
        if (aH < 0) {
            return 0;
        }
    ...
    function W(aJ) {
        ...
        for (var aH = 0; aH < this.CHANNEL_COLORS.length; aH++) {
            this
                .dp_webgl
                .setChannelFlagAsColor(aH, this.CHANNEL_COLORS[aH]);
        }
    }
    W.CHANNEL_COUNT                        = 4;
    ...
    W.prototype.releaseShader              = function () {
        ...
        for (var aH = 0; aH < aI; aH++) {
            this
                .gl
                .deleteFramebuffer(Q.frameBuffers[aH].framebuffer);
        }
        Q.frameBuffers = [];
        Q.glContext    = [];
    };
    ...
    W.prototype.setupClip                  = function (a1, aQ) {
        ...
        if (aK > 0) {
            var aM = aQ
                .gl
                .getParameter(aQ.gl.FRAMEBUFFER_BINDING);
            var aW = new Array(4);
            aW[0] = 0;
            aW[1] = 0;
            ...
            aQ
                .gl
                .viewport(0, 0, Q.clippingMaskBufferSize, Q.clippingMaskBufferSize);
            ...
            for (var aO = 0; aO < this.clipContextList.length; aO++) {
                ...
                this
                    .tmpBoundsOnModel
                    .expand(aT.width * aJ, aT.height * aJ);
                ...
                this
                    .tmpMatrix2
                    .translate(aV.x, aV.y, 0);
                this
                    .tmpMatrix2
                    .scale(aZ, aY, 1);
                this
                    .tmpMatrix2
                    .translate(-this.tmpBoundsOnModel.x, -this.tmpBoundsOnModel.y, 0);
                this
                    .tmpMatrixForMask
            ...
            aQ
                .gl
                .bindFramebuffer(aQ.gl.FRAMEBUFFER, aM);
            aQ.setClipBufPre_clipContextForMask(null);
            aQ
                .gl
                .viewport(aW[0], aW[1], aW[2], aW[3]);
        }
    };
    ...
    function U(aH, aK, aI) {
        ...
        for (var aJ = 0; aJ < aI.length; aJ++) {
            this
                ...
                .push(aK.getDrawDataIndex(aI[aJ]));
        }
    ...
    ah.prototype.updateParam         = function (aJ, aN) {
        ...
        var aH = (this._$dP == 0)
            ? 1
            : A._$r2(((aL - aN._$bs) / (this._$dP)));
        var aK = (this._$eo == 0 || aN._$Do < 0)
            ? 1
            : A._$r2(((aN._$Do - aL) / (this._$eo)));
        aI = aI * aH * aK;
        if (!((0 <= aI && aI <= 1))) {
            console.log("### assert!! ### ");
        }
    ...
    u.prototype._$Yb             = function () {
        return (
            -180 * (Math.atan2(this.p1.x - this.p2.x, -(this.p1.y - this.p2.y))) / Math.PI
        );
    };
    ...
    u.prototype.update           = function (aI, aL) {
        if (this._$iP == 0) {
            ...
            this._$Fo = (
                Math.sqrt((this.p1.x - this.p2.x) * (this.p1.x - this.p2.x) + (this.p1.y - this.p2.y) * (this.p1.y - this.p2.y))
            );
            return;
        }
            ...
            if (a1 == 1) {
                ...
                if (a1 == 2) {
                    ...
                    if (a1 == 3) {
                        ...
                        var a5 = a9[2];
                        return (1 - a5) * (
                            (1 - a7) * (aP + (aO - aP) * a8) + a7 * (bn + (bm - bn) * a8)
                        ...
                        if (a1 == 4) {
                            ...
                            var a3 = a9[3];
                            return (1 - a3) * (
                                (1 - a5) * ((1 - a7) * (aT + (aS - aT) * a8) + a7 * (bs + (br - bs) * a8)) + a5 * ((1 - a7) * (aN + (aM - aN) * a8) + a7 * (bl + (bk - bl) * a8))
                            ) + a3 * (
                                (1 - a5) * ((1 - a7) * (bd + (bb - bd) * a8) + a7 * (aX + (aW - aX) * a8)) + a5 * ((1 - a7) * (a6 + (a4 - a6) * a8) + a7 * (aR + (aQ - aR) * a8))
                            );
                        } else {
                            var aV = 1 << a1;
                            var aY = new Float32Array(aV);
        ...
        for (var aU = 0; aU < this.motions.length; aU++) {
            ...
            if (aS._$RP == t._$hs) {
                ...
                if (t._$ws <= aS._$RP && aS._$RP <= t._$Ys) {} else {
                    ...
                    var aY = aS._$I0[(aJ >= aK
                            ? aK - 1
                            : aJ)];
                    var aW = aS._$I0[(aJ + 1 >= aK
                            ? aK - 1
                            : aJ + 1)];
                    var aI = aY + (aW - aY) * aP;
                    var aN = aR + (aI - aR) * aO;
    ...
    x.prototype._$Uo         = function (aO, aH, aP, aI, aQ, aM, aK, aJ) {
        ...
        this
            .gl
            .drawElements(aL, aP, aI, aQ, aM, aN, this.transform, aJ);
    };
        ...
        for (var aZ = 0; aZ < this.motions.length; aZ++) {
            ...
            if (aV._$RP == t._$hs) {
                ...
                if (t._$ws <= aV._$RP && aV._$RP <= t._$Ys) {} else {
                    ...
                    var a2 = aV._$I0[(aK >= aL
                            ? aL - 1
                            : aK)];
                    var a1 = aV._$I0[(aK + 1 >= aL
                            ? aL - 1
                            : aK + 1)];
                    var aI;
        ...
        for (var ba = aP; ba < aW; ba += aI) {
            ...
            if (bd < 0 || a7 < 0 || aQ <= bd || aU <= a7) {
                ...
                if (!aZ) {
                    aZ = true;
                    aT = 0.25 * (
                        aR[((0) + (0) * a1) * 2] + aR[((aQ) + (0) * a1) * 2] + aR[((0) + (aU) * a1) * 2] +
                            aR[((aQ) + (aU) * a1) * 2]
                    );
                    aS = 0.25 * (
                        aR[((0) + (0) * a1) * 2 + 1] + aR[((aQ) + (0) * a1) * 2 + 1] + aR[((0) + (aU) * a1) * 2 + 1] +
                            aR[((aQ) + (aU) * a1) * 2 + 1]
                    );
                ...
                if (bn + bm < 1) {
                    ...
                    bc[ba]     = aR[aV + 2 * (aQ + 1) + 2] * (bn - 1 + bm) + aR[aV + 2 * (aQ + 1)] * (
                        1 - bn
                    ) + aR[aV + 2] * (1 - bm);
                    bc[ba + 1] = aR[aV + 2 * (aQ + 1) + 3] * (bn - 1 + bm) + aR[aV + 2 * (aQ + 1) + 1] * (
                        1 - bn
                    ) + aR[aV + 3] * (1 - bm);
                }
            }
    ...
    E.prototype.transformPoints_sdk1 = function (aJ, aR, aL, a0, aU, aP, aZ) {
        ...
        for (var aK = aP; aK < aI; aK += aZ) {
            ...
            if (aX + aW < 1) {
                ...
                a0[aK]     = aT[aV + 2 * (aM + 1) + 2] * (aX - 1 + aW) + aT[aV + 2 * (aM + 1)] * (
                    1 - aX
                ) + aT[aV + 2] * (1 - aW);
                a0[aK + 1] = aT[aV + 2 * (aM + 1) + 3] * (aX - 1 + aW) + aT[aV + 2 * (aM + 1) + 1] * (
                    1 - aX
                ) + aT[aV + 3] * (1 - aW);
            }
        }
    ...
    s.prototype.init        = function (aI) {
        var aH = new aj(this);
        aH.setPartsOpacity(this.isVisible()
            ? 1
            : 0);
        return aH;
    };
    ...
    l.prototype.update                = function () {
        ...
        this
            ._$5S
            .preDraw(this.drawParamWebGL);
    };
    l.prototype.draw                  = function () {
        this
            ._$5S
            .draw(this.drawParamWebGL);
    };
    ...
    C.prototype._$ZT         = function () {
        ...
        if (this.firstDraw) {
            ...
            this.anisotropyExt = aH.getExtension("EXT_texture_filter_anisotropic") || aH.getExtension(
    ...
    C.prototype.loadShaders2      = function () {
        ...
        var aK = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2      " +
                " v_texCoord;varying vec4       v_ClipPos;uniform mat4       u_mvpMatrix;void m" +
                "ain(){    gl_Position = u_mvpMatrix * a_position;    v_ClipPos = u_mvpMatrix *" +
                " a_position;    v_texCoord = a_texCoord;}";
        var aM = "precision mediump float;varying vec2       v_texCoord;varying vec4       v_Cli" +
                "pPos;uniform sampler2D  s_texture0;uniform vec4       u_channelFlag;uniform ve" +
                "c4       u_baseColor;uniform bool       u_maskFlag;void main(){    vec4 smpCol" +
                "or;     if(u_maskFlag){        float isInside =             step(u_baseColor.x" +
                ", v_ClipPos.x/v_ClipPos.w)          * step(u_baseColor.y, v_ClipPos.y/v_ClipPo" +
                "s.w)          * step(v_ClipPos.x/v_ClipPos.w, u_baseColor.z)          * step(v" +
                "_ClipPos.y/v_ClipPos.w, u_baseColor.w);        smpColor = u_channelFlag * text" +
                "ure2D(s_texture0 , v_texCoord).a * isInside;    }else{        smpColor = textu" +
                "re2D(s_texture0 , v_texCoord) * u_baseColor;    }    gl_FragColor = smpColor;}";
        var aL = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2      " +
                " v_texCoord;varying vec4       v_ClipPos;uniform mat4       u_mvpMatrix;unifor" +
                "m mat4       u_ClipMatrix;void main(){    gl_Position = u_mvpMatrix * a_positi" +
                "on;    v_ClipPos = u_ClipMatrix * a_position;    v_texCoord = a_texCoord ;}";
        var aJ = "precision mediump float ;varying vec2       v_texCoord;varying vec4       v_Cl" +
                "ipPos;uniform sampler2D  s_texture0;uniform sampler2D  s_texture1;uniform vec4" +
                "       u_channelFlag;uniform vec4       u_baseColor ;void main(){    vec4 col_" +
                "formask = texture2D(s_texture0, v_texCoord) * u_baseColor;    vec4 clipMask = " +
                "texture2D(s_texture1, v_ClipPos.xy / v_ClipPos.w) * u_channelFlag;    float ma" +
                "skVal = clipMask.r + clipMask.g + clipMask.b + clipMask.a;    col_formask = co" +
                "l_formask * maskVal;    gl_FragColor = col_formask;}";
